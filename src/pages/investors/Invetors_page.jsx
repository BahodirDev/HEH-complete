            ...
            <div className="row invest_title_row">
                ...
                <div className="col-lg-12 invest_post">
                    <p className='invest_post_p'>
                        For the development, expansion and maintenance of the HEH network, we need a six-digit amount in the long term, which can only be financed over time through the income from the app itself.

                        Are you an investor, entrepreneur or private individual and feel committed to liberal-conservative values? The HEH network offers attractive participation models from EUR 10,000 for supporters who help us to scale our business model. Come on board so we can no longer do right winger conservatism; no longer leave liberalism to the big landowners.</p>
                </div>
            </div>
        </div>
    );
